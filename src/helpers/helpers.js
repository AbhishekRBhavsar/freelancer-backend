...
exports.generateJWTtoken = (object, secretKey = envConstants.JWT_SECRET) => jwt.sign(
  object,
  secretKey,
  { expiresIn: envConstants.JWT_TOKEN_EXPIRATION_TIME },
);
...
exports.genericValidator = (allowedParams, requiredParams) => (req, res, next) => {
  ...
  if (failed) {
    return exports.errorResponse(req, res, errorMessages.INVALID_PARAMS, 400, invalidString);
  }
  return next();
};
